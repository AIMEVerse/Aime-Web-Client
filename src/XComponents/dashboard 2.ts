        ...
        <div _html_tag="aside">
            ...
            <div class="top">
                ...
                <div class="close" id="close-btn">
                    <span class="material-icons material-symbols-sharp">close</span>
                </div>
            </div>
            <div class="sidebar">
                <a href="#" class="active">
    ...
    constructor(data) {
        ...
        <div>
            ...
            <div class="insights">
                ...
                <div class="expenses">
                    <span class="material-icons material-symbols-sharp">bar_chart</span>
                    <div class="middle">
                        <div class="left">
                    ...
                    <h2 class="text muted">Last 24 hours</h2>
                </div>
  
                <div class="income">
                    <span class="material-icons material-symbols-sharp">stacked_line_chart</span>
                    <div class="middle">
                        <div class="left">
                            <h2>Total Income</h2>
                            <h2>$13,476</h2>
