...
import nano_spell from './nano-spells/s3do-nano-spells'
...
class Spell3dObject {
    ...
    static get_spell_data(three_obj, defaults) {
        ...
        if (defaults) {
            SpellUtils.mergeDefaultsWithData(_spell_data, defaults)
        }
        return _spell_data
    }
    ...
    constructor(data, defaults) {
        ...
        this._scale = { x: 1, y: 1, z: 1 },
            this._visible = true
        this[_SC.NODES.type] = "spell3d-object";
